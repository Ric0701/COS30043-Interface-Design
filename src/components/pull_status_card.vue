...
const getFiveStar = () =>
  gacha_store.add_pull({ rarity: 5, type: props.bannerType });
const getFourStar = () =>
  gacha_store.add_pull({ rarity: 4, type: props.bannerType });
const removeSinglePull = () =>
  gacha_store.remove_pull({ type: props.bannerType });
...
<template>
  ...
  <div class="col-12 col-md-6 col-lg-3">
    <div class="card custom-dark-card p-3">
      ...
      <div v-if="!isEditing">
        <div
          class="info-box mb-2 p-2 d-flex justify-content-between align-items-center"
        >
          <div>
        ...
        >
          <div>
            ...
            <div class="text-muted small">
              Guaranteed at {{ maxFiveStarPity }} pulls
            </div>
          </div>
        ...
        >
          <div>
            ...
            <div class="text-muted small">
              Guaranteed at {{ maxFourStarPity }} pulls
            </div>
          </div>
        ...
        <div class="row g-2 mb-2">
          ...
          <div class="row g-2">
            <div class="col-4">
              <button class="btn btn-outline-dark w-100" @click="addSinglePull">
                +1
              </button>
            </div>
            <div class="col-4">
      ...
      <div v-else>
        ...
        <div class="mb-3">
          <label class="small text-white mb-1"
            >5★ Pity (Guaranteed at {{ maxFiveStarPity }})</label
          >
          <input
            type="number"
            class="form-control custom-input"
            v-model.number="editFivePity"
            min="0"
            :max="maxFiveStarPity"
          />
        </div>
        ...
        <div class="mb-4">
          <label class="small text-white mb-1"
            >4★ Pity (Guaranteed at {{ maxFourStarPity }})</label
          >
          <input
            type="number"
            class="form-control custom-input"
            v-model.number="editFourPity"
            min="0"
            :max="maxFourStarPity"
          />
        </div>
        ...
        <button
          ...
          style="background-color: #3f4561; border: none"
          @click="saveEdit"
        >
          Save
        </button>
