  ...
  >
    ...
    >
      ...
      <form @submit.prevent="handleRegister">
        <div class="mb-3">
          <label class="text-dark small mb-1" for="reg-username"
            >Username</label
          >
          <input
            type="text"
        ...
        <div class="mb-3">
          <label class="text-dark small mb-1" for="reg-password"
            >Password</label
          >
          <input
            type="password"
        ...
        <div class="mb-4">
          <label class="text-dark small mb-1" for="confirm-password"
